    ...
    <div class="wrapper mt-3">
            <div class="header">
                    <div class="float-left text-center" style="max-width:500px;margin-left:50px;padding-top:40px">
                        ...
                        <p>Laporan Uang Keluar Per tanggal <b>{{ tanggal_indonesia($tgl_dari, false) }}</b> sampai <b>{{ tanggal_indonesia($tgl_sampai, false) }}</b></p>
                    </div>
            ...
            <div class="body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @forelse ($uangkeluar as $no => $uang)
                                    <tr>
                                        <td>{{ ++$no }}</td>
                                        <td>{{ tanggal_indonesia($uang->tanggal_keluar) }}</td>
                                ...
                                <tr>
                                    ...
                                    <td><b>Rp. {{ format_uang($uangkeluar->sum('nominal'))}}</b></td>
                                </tr>
                            </tbody>
                        </table>
