...
<div class="container-fluid">
    <div class="fade-in">
        ...
        <form action="{{ route('kegiatan.update', $kegiatan->id) }}" method="post" id="myform">
          @csrf @method('PATCH')
          <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="form-control" autofocus value="{{ $kegiatan->nama_kegiatan }}">
                        @error('nama_kegiatan')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="estimasi_biaya_input" id="estimasi_biaya_input" class="form-control" autofocus value="{{ $kegiatan->estimasi_biaya }}">
                        <input type="hidden" name="estimasi_biaya" id="estimasi_biaya" class="form-control" autofocus value="{{ $kegiatan->estimasi_biaya }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="deadline" id="deadline" class="form-control" value="{{ $kegiatan->deadline }}">
                        @error('deadline')
                                <span class="text-danger text-error" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="radio" name="status" id="rencana" value="rencana" @if($kegiatan->status == 'rencana') checked @endif>
                            <label for="rencana">Rencana</label>
                            <input type="radio" name="status" id="dilaksanakan" value="dilaksanakan" @if($kegiatan->status == 'dilaksanakan') checked @endif>
                    ...
                    <div class="form-group" id="section_tanggal_dilaksanakan">
                        ...
                        <input type="text" name="tanggal" id="tanggal" class="form-control" value="{{ $kegiatan->tanggal_dilaksanakan, $kegiatan->id }}">
                        @error('tanggal')
                                <span class="text-danger text-error" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
