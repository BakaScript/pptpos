                    ...
                    <form action="" method="post" id="printForm">
                        ...
                        <input type="hidden" name="mode" id="mode">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="radio" name="status" id="semua" value="semua" checked>
                                    <label for="semua">Semua</label>
                                    <input type="radio" name="status" id="rencana" value="rencana">
...
@section('scripts')
    <script>
        ...
        {
            $('#mode').val(mode) ;
            $('#printForm').attr('action', "{{ route('kegiatan.print.pdf') }}") ;
            $('#printForm').submit() ;
        }
    </script>
@endsection
