...
<div class="container-fluid">
    <div class="fade-in">
        ...
        <form action="{{ route('uangmasuk.update', $uangmasuk->id) }}" method="post" id="myform">
          @csrf
          @method('PATCH')
          <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="sumber" id="sumber" class="form-control" autofocus value="{{ $uangmasuk->sumber }}">
                        @error('sumber')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text">
                              ...
                              <input class="form-control" id="nominalinput" type="text" value="{{ $uangmasuk->nominal }}">
                              <input class="form-control" id="nominal" type="hidden" name="nominal" value="{{ $uangmasuk->nominal }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tanggal" id="tanggal" class="form-control" value="{{ $uangmasuk->tanggal_masuk }}">
                        @error('tanggal')
                                <span class="text-danger text-error" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
