    ...
    <div class="wrapper mt-3">
            <div class="header">
                    <div class="float-left text-center" style="max-width:500px;margin-left:50px;padding-top:40px">
                        ...
                        <p>Laporan Uang Masuk Per tanggal <b>{{ tanggal_indonesia($tgl_dari, false) }}</b> sampai <b>{{ tanggal_indonesia($tgl_sampai, false) }}</b></p>
                    </div>
            ...
            <div class="body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @forelse ($uangmasuk as $no => $uang)
                                    <tr>
                                        <td>{{ ++$no }}</td>
                                        <td>{{ tanggal_indonesia($uang->tanggal_masuk) }}</td>
                                        <td>{{ $uang->sumber }}</td>
                                ...
                                <tr>
                                    ...
                                    <td><b>Rp. {{ format_uang($uangmasuk->sum('nominal'))}}</b></td>
                                </tr>
                            </tbody>
                        </table>
